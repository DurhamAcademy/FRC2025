...
public final class FieldConstants {
    ...
    public static class LocationConstants {
        ...
        public static final Map<AlgaeConstants, Pose2d[]> AlgaeLocations =
                new HashMap<>() {
                    {
                        // centers of the hexagons
                        double blueY = Units.inchesToMeters(158.5);
                        ...
                        // for the 1 and 4 positions where the edge is parallel to the
                        // alliance walls
                        double changeXParallel = Units.inchesToMeters(32.75);

                        // for 2, 3, 5 and 6 (the slanted sides)
        ...
        // https://drive.google.com/file/d/1K155pCUQ5puJRHuw8-uzw9tF79fYn8L3/view?usp=sharing
        public static final List<AlgaeConstants> AllAlgaeLocations =
                List.of(
                        AlgaeConstants.ONE,
                        AlgaeConstants.TWO,
                        AlgaeConstants.THREE,
        ...
        public static List<Pose2d> PosesOfAllAlgaeLocations(int color) {
            List<Pose2d> allPoses = new ArrayList<>();
            for (int i = 0; i < AllAlgaeLocations.size(); i++) {
                allPoses.add(AlgaeLocations.get(AllAlgaeLocations.get(i))[color]);
            }
            return allPoses;
        }
    }
